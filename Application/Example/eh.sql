...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2023 at 02:33 PM
...
--
ALTER TABLE `ceo`
  ADD CONSTRAINT `ceo_ibfk_1` FOREIGN KEY (`Firma`) REFERENCES `klienci` (`nazwa`);

--
-- Constraints for table `zamowienia`
--
ALTER TABLE `zamowienia`
  ADD CONSTRAINT `zamowienia_ibfk_1` FOREIGN KEY (`Firma`) REFERENCES `klienci` (`nazwa`),
  ADD CONSTRAINT `zamowienia_ibfk_3` FOREIGN KEY (`Nazwisko`) REFERENCES `ceo` (`Nazwisko`);
COMMIT;
